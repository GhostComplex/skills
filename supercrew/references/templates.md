...
Use this template when handing off a project to another developer or onboarding to an existing project.
...
## Contacts
- {role}: {name/handle} — {what they own}

## Checklist
- [ ] Incoming dev has repo access
- [ ] Incoming dev can build and run locally
- [ ] Incoming dev has reviewed this document
- [ ] All WIP pushed to repo
- [ ] Memory files updated in `memory/{platform}-{id}/`
- [ ] Handoff announced in group channel
```
